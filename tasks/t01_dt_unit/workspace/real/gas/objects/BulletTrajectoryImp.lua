...
function BulletTrajectoryImp:_StartBulletTrajectoryMove(obj, MoveArgs)
	...
	elseif trajectory == EnumBulletTracjectory.CircleChase then 
		self:StartCircleChaseMove(obj, MoveArgs, trajectoryArgs)
		return true
...
function BulletTrajectoryImp:StartCircleChaseMove(Obj, MoveArgs, TrajectoryArgs)
	local BulletData = Obj.m_BulletMoveData
	...
	BulletData.m_TargeterEngineObjectId = MoveArgs.TargetId
	BulletData.m_StartTime = GetGlobalTime_ms()
	local trajectoryArgs = BulletData.m_TrajectoryArgs
	BulletData.m_TotalTime = trajectoryArgs[1]
	BulletData.m_Radius1 = trajectoryArgs[2] * 64
	BulletData.m_Radius2 = trajectoryArgs[3] * 64
